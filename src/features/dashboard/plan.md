...
- [ ] **`clientes` tem 312 e-mails duplicados**, o que impede o índice único e deixa o `fn_resolver_cliente` sujeito a corrida sob concorrência. Deduplicar exige remapear `vendas.cliente_id` e `assinaturas.cliente_id` antes
