...
**Pendências:**
- [ ] **Base do Simples inclui juros de parcelamento — verificar com a contabilidade.** A view calcula o imposto sobre `valor_total` (o pago), então hoje aparece R$ 409,89 em vez dos R$ 394,66 que dariam 10% da receita real. Como o produtor não recebe o juro, a base provavelmente deveria ser `valor_sem_juros`, mas mexer em base de imposto exige confirmação
